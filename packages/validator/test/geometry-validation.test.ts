...
const DEFAULT_FOOTPRINT =
  '<polygon id="apartment-footprint" points="0,0 500,0 500,500 0,500" data-kind="footprint" />';
...
function createSvg(contents: Partial<Record<GroupId, string>> = {}): string {
  ...
  return `<svg xmlns="${SVG_NAMESPACE_URI}" viewBox="0 0 500 500" data-schema="apartment-svg" data-schema-version="2.2" data-unit="cm">
