...
const DEFAULT_FOOTPRINT =
  '<polygon id="apartment-footprint" points="-500,-500 1500,-500 1500,1500 -500,1500" data-kind="footprint" />';
...
function createSvg(contents: Partial<Record<GroupId, string>> = {}): string {
  ...
  return `<svg xmlns="${SVG_NAMESPACE_URI}" viewBox="-500 -500 2000 2000" data-schema="apartment-svg" data-schema-version="2.2" data-unit="cm">
