...
Window planes now use physically based transmission with zero thickness, with qualitative clear/frosted/tinted defaults. Persistent material assets, design scenarios, image-based/environment lighting (IBL), exposure, and tone-mapping controls remain future work. Glass appearance is still limited by the current lighting.
