...
The renderer consumes these surfaces with the existing neutral materials and source selection groups. UVs, textures, real material assignment, material assets, IBL, improved glass, and exposure/tone-mapping controls remain subsequent Phase 1 work; design scenarios are not implemented.
